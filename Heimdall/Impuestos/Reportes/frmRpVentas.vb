    ...
    Private Sub cmdGenerar_Click(sender As Object, e As EventArgs) Handles cmdGenerar.Click
        Try
            ...
            If cboEstablecimiento.Text = "Todos" Then
                cmd.CommandText = "select * from ventas where fecha_comprobante between '" + txtDesde.Text + "' and '" + txtHasta.Text + "';"
            Else
                cmd.CommandText = "select * from ventas where establecimiento='" + cboEstablecimiento.Text + "' and fecha_comprobante between '" + txtHasta.Text + "' and '" + txtDesde.Text + "';"
            End If
